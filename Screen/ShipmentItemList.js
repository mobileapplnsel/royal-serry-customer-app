...
<Text style={styles.login}>Shipment Order List</Text>
...
{/* <TouchableOpacity onPress ={() => this.props.navigation.navigate('StastShipmentPage',{
              ...
              <Text style={{  marginTop: 20, fontSize:15,fontWeight: "bold",color:'white',
 textAlign: 'center', textAlignVertical: 'center', height: 40,
 marginLeft:  13,
borderRadius:2,width: 80,
color: 'white', backgroundColor: 'green', width: 170, marginBottom: 25, textAlignVertical: 'center', alignSelf: 'center'}}>
   Create Quote
</Text> 
</TouchableOpacity> */}
...
{/* { this.state.isListDataAvlble == false && <View> <Image style={{ height: 96,
  width:  96,
marginTop:80,borderRadius:2,alignSelf: 'center', tintColor: 'red'}}
...
<Text style={{
      ...
      color:'red',
      alignSelf:'center',
      marginTop:13,}}>No Order Found</Text>
</View>
} */}
...
<View style={{flexDirection:'row', alignItems: 'center', justifyContent: 'center', marginTop: 0}}>
            ...
            <View>
              <Text style={{ fontSize: 13, color: 'grey', marginLeft: 13, marginBottom: 10, fontWeight: "bold" }}>Order Number</Text>
            ...
            <View>
              <Text style={{ fontSize: 13, color: 'grey', marginBottom: 10 }}>{item.shipment_no}</Text>
 ...
 marginLeft:  13, marginTop:0,borderRadius:2, backgroundColor: 'green', width: 170, marginBottom: 25}} onPress ={() => this.props.navigation.navigate('ShipmentItemDetailsPage',{
                      shipment_id: item.id})}>
              <Text style={{  fontSize:15,fontWeight: "bold",color:'white',
 textAlign: 'center', textAlignVertical: 'center', padding: 10,
color: 'white', textAlignVertical: 'center', alignSelf: 'center'}}>
   View Details
</Text> 
</TouchableOpacity>
     ...
     FetchQuoteList = () => {
      ...
      params = 
      {
        ...
        user_id: this.state.UserIDString//'22' //22
    ...
    const { navigate } = this.props.navigation;
      ...
      const url = UrlUtil.BASE_URL + 'api/orderList';
    ...
    { 
        ...
        if (json.status == 'success')
        {
          ...
          this.setState({shipmentList: json.orderList})
          this.setState({progress:false, isListDataAvlble: true})
