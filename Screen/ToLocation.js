...
else
{
 ...
 if (this.props.navigation.state.params.addressDict.description != undefined)
 {
  ...
  console.log('total params1: ', this.props.navigation.state.params, this.props.navigation.state.params.addressState, this.props.navigation.state.params.addressCity)

   this.setState({ 
    ToAddress1String: this.props.navigation.state.params.addressDict.description,
    toLattitude: this.props.navigation.state.params.Lat,
    toLogitude: this.props.navigation.state.params.Long,
 ...
 else
 {
  ...
  copyFetchStateIDCountryID = (flagname, param) => {
    ...
    console.log('copyFetchStateIDCountryID called', flagname, param)
     ...
     if (this.props.navigation.state.params.addressDict.description != undefined)
     {
      ...
      if (flagname == 'country')
      {
        ...
        this.setState({ 
          ...
          ToStateString: '',
          // ToCityString: this.props.navigation.state.params.addressCity,
          toSelectedCountryID: json.locatioID.id,
          toSelectedStateID: '',
          ToCityString: 'City',
          ToStateString: 'State',
          toSelectedCityID: '',
...
<TouchableOpacity onPress={() => this.setState({showOrHidePhone2Flag: 'show'})}> 
              <Text style={{ marginTop: 7, fontSize:10,fontWeight: "bold",color:'white',
...
<View style={{marginLeft:13,marginTop:14, marginRight: 13}}>
                <RadioForm
...
/>
                ...
                { this.state.fromToLocationFlag == 'to' && <TouchableOpacity style={{ height: 40,
...
<TouchableOpacity style={{ height: 40, alignSelf: 'center',borderRadius:2,width: 140, backgroundColor: 'red', marginTop: 20}} onPress ={() => this.authenticateUserNoteToAdminApiCall()}>
              <Text style={{  fontSize:20,fontWeight: "bold",color:'white',
 textAlign: 'center', textAlignVertical: 'center', alignSelf: 'center', padding: 6,
color: 'white',}}>
   Send
</Text> 
</TouchableOpacity>
...
{ 
  ...
  { 
    ...
    { 
       ...
       if (this.state.ToFirstnameString.trim() == '') {
        alert('Please Enter First Name in To Location segment');
      }
      else if (this.state.ToLastnameString.trim() == '') {
        alert('Please Enter Last Name in To Location segment');
      }
      else if (this.state.ToAddress1String.trim() == '') {
      alert('Please Enter Address 1 in To Location segment');
      }
      // else if (this.state.ToAddress2String.trim() == '') {
      // alert('Please Enter Address 2 in To Location segment');
      // }
      else if (this.state.ToCountryString == 'Country') {
      alert('Please Select Your Country in To Location segment');
      }
      else if (this.state.ToStateString == 'State') {
      alert('Please Select Your State in To Location segment');
      }
      else if (this.state.ToCityString == 'City'|| this.state.ToCityString == undefined) {
      alert('Please Select Your City in To Location segment');
      }
      else if (this.state.ToZipCodeString.trim() == '') {
      alert('Please Enter Zip Code in To Location segment');
      }
      else if (this.state.ToPhoneString.trim() == '') {
      alert('Please Enter Phone Number in To Location segment');
      }
      // else if (this.state.ToEmailString.trim() == '') {
      // alert('Please Enter Email in To Location segment');
      // }

        else {
      
          let reg = /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w\w+)+$/;
  if (this.state.ToEmailString.trim() != '' && reg.test(this.state.ToEmailString.trim()) === false) {
    ...
    alert('Email is Not Correct');
          ...
          dictionary_main1['ToFirstnameString'] = this.state.ToFirstnameString
          dictionary_main1['ToLastnameString'] = this.state.ToLastnameString
          dictionary_main1['ToAddress1String'] = this.state.ToAddress1String
          dictionary_main1['ToAddress2String'] = this.state.ToAddress2String
          dictionary_main1['ToCompanyString'] = this.state.ToCompanyString
          dictionary_main1['ToCountryString'] = this.state.ToCountryString
          dictionary_main1['ToStateString'] = this.state.ToStateString
          dictionary_main1['ToCityString'] = this.state.ToCityString
          dictionary_main1['ToZipCodeString'] = this.state.ToZipCodeString
          dictionary_main1['ToEmailString'] = this.state.ToEmailString
          dictionary_main1['ToPhoneString'] = this.state.ToPhoneString
          dictionary_main1['ToPhoneString1'] = this.state.ToPhoneString1
          dictionary_main1['ToAddressTypeString'] = this.state.ToAddressTypeString
          dictionary_main1['toSelectedCountryID'] = this.state.toSelectedCountryID
          dictionary_main1['toSelectedStateID'] = this.state.toSelectedStateID
          dictionary_main1['toSelectedCityID'] = this.state.toSelectedCityID
          dictionary_main1['toLattitude'] = this.state.toLattitude
          dictionary_main1['toLogitude'] = this.state.toLogitude
      
      
      var dictionary_main2 = this.props.navigation.state.params.quoteOrShipmentData
      dictionary_main2['toUserdata'] = dictionary_main1
      ...
      {
        AsyncStorage.setItem('toselectedStateID', this.state.toSelectedStateID);
      }
 ...
 this.setState({
  ...
  NextButtonCliecked()
  {
    ...
    // this.customZipValidationCheck1(this.state.ToZipCodeString)
     this.customZipValidationCheck2(this.state.ToZipCodeString)
