...
else
{
  this.setState({
    Address1String: ''
     ...
     else if (this.props.navigation.state.params.navigationFlagForAddress1 == 'editProfilePicker')
     {
      if (this.props.navigation.state.params.flagtoShow == 'country')
      {
        this.setState({selectedCountryID: this.props.navigation.state.params.selectedCountryID, CountryString: this.props.navigation.state.params.CountryString})
      }
...
source={require('../Images/logo.png')}>
 ...
 <Spinner
        ...
        />
 <ScrollView >
                <Text style={styles.login}>Manage Account</Text>
...
<TouchableOpacity onPress={() => navigate('GoogleAddressPage',{
                      navigationFlagForAddress1: 'editprofile'})}>
                <TextInput style={styles.textInput}
                placeholder={'Address 1'}
                placeholderTextColor={'grey'}
                autoCapitalize = 'none'
...
{ this.state.emailOrPhoneFlag != 'email' &&  <TextInput style={styles.textInput}
                ...
                marginTop:20, marginBottom: 20}} onPress ={() => this.props.navigation.navigate('ChangePasswordPage',{
...
// console.disableYellowBox = true; 
  ...
  CallToShowDropDownCombo(selectedFlag) 
  {
    ...
    navigate('cityStateCountryPickerPage',{
      navigationFlagForAddress1: 'editProfilePicker', flagtoShow: 'country'})
        ...
        if (this.state.selectedCountryID != '')
{
      ...
      // })
        ...
        selectedComboFlag = 'state'
         navigate('cityStateCountryPickerPage',{
          navigationFlagForAddress1: 'editProfilePicker', flagtoShow: 'state', countryID: this.state.selectedCountryID})
    }
    else
    {
    ...
    if (selectedFlag == 'city') 
    {
      ...
      else
      {
        ...
        selectedComboFlag = 'city'
        navigate('cityStateCountryPickerPage',{
         navigationFlagForAddress1: 'editProfilePicker', flagtoShow: 'city', stateID: this.state.selectedStateID})
