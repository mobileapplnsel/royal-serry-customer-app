...
//org.reactjs.native.example.RoyalSherry
...
//  return [[RCTBundleURLProvider sharedSettings] jsBundleURLForBundleRoot:@"index" fallbackResource:nil];
  return [NSURL URLWithString:@"http://172.20.10.6:8081/index.bundle?platform=ios&dev=true&minify=false&hot=true"];
#else
